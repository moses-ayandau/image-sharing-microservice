...
public class DeleteImageHandlerTest {
    ...
    void setUp() {
        ...
        dynamoItem = Map.of("imageKey", AttributeValue.builder().s("image123.jpg").build());
    ...
    void testSuccessfulImageDeletion() {
        ...
        verify(mockS3Utils).copyObject(eq("mock-bucket"), eq("image123.jpg"), eq("recycle/image123.jpg"));
        verify(mockS3Utils).deleteObject(eq("mock-bucket"), eq("image123.jpg"));
        verify(mockDynamoUtils).updateImageStatus(eq("MockTable"), eq("image123"), eq("inactive"));
        verify(mockDynamoUtils).updateS3Key(eq("MockTable"), eq("image123"), eq("recycle/image123.jpg"));
    }
