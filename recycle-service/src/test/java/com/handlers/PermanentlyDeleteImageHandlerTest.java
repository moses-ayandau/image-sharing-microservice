...
public class PermanentlyDeleteImageHandlerTest {
    ...
    @Test
    void testHandleRequest_EmptyImageId() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
    ...
    @Test
    void testHandleRequest_EmptyUserId() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
    ...
    @Test
    void testHandleRequest_MissingS3Key() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_NullS3Key() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_EmptyS3Key() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_NotInRecycleBin() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_OwnershipValidationException() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_S3DeleteException() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_DynamoDeleteException() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_GetItemFromDynamoException() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
    ...
    @Test
    void testHandleRequest_EmptyDynamoResponse() {
        APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent();
        request.setPathParameters(Map.of("imageKey", IMAGE_ID));
        request.setQueryStringParameters(Map.of("userId", USER_ID));
